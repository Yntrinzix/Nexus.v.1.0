					...
					<div class="modal-content">
						...
						<div class="modal-body">
                            ...
                            <div id="myReportModal" >
								...
								<div class="mngReport">
									<?php 
                                        ...
                                        include('dbmanager/task-report-mng.php');
                            ...
                            <div id="myFilterModal">
								...
								<!--employee select-->
                                    <h6 style="text-align:left">Filter Calendar by Employee</h6>
                                    <div class="row">
									<div class="col-lg-12">
									  <select name="event-employees[]" id="employee-filter" style="width:100%">
										  <option value="1" class="assigned">John Mark Martinez</option>
										  <option value="2" class="assigned">Vany Deloso</option>
										  <option value="3" class="assigned">John Frades</option>
										  <option value="4" class="assigned">Kaye Pada</option>
								...
								<div class="modal-footer">
	<button type="submit" name ="button" value="add" class="btn btn-success" id="filter-event" data-dismiss="modal" onclick="location.reload()">Reset</button> 								
  <button type="submit" class="btn btn-success" id="filter-event" data-dismiss="modal" data-target="#data" onclick="filterProcess()">Filter</button>  
									<button type="button" name ="button" value="done" class="btn btn-default" data-dismiss="modal">Close</button>
                            </div>

...
function editEvent(event) {
	if(modalTitle==1){
		...
		document.getElementById('done-event').style.visibility = 'hidden';
	}
	else if(modalTitle==0) {
		document.getElementById("mod-title").innerHTML = "Update Task";
		document.getElementById('done-event').style.visibility = 'visible';
	}
...
function saveEvent() {
	...
	if($('#event-modal input[name="event-name"]').val()!= ''){
		...
		alert("Data Unsaved, Task Name is Empty");
...
/*				
      yearChanged: function(e) {
                        ...
                        $.ajax({
                            url: "https://ieventdemoqna.000webhostapp.com/js/test.json",
                            dataType: "json",
        ...
        dataSource: [
            {
                id: myDataa[0].id,
                name: myDataa[0].name,
                location: myDataa[0].location,
				startDate: new Date(myDataa[0].startYear, myDataa[0].startMonth, myDataa[0].startDay),
                endDate: new Date(myDataa[0].endYear,  myDataa[0].endMonth,  myDataa[0].endDay)
			...
			dataSource: [
            {
				...
				startDate: new Date(myData.startYear, myData.startMonth, myData.startDay),
                endDate: new Date(myData.endYear,  myData.endMonth,  myData.endDay)

...
function loadJASON() {
	...
	$.ajaxSettings.async = true;
		/*var data_file = "https://ieventdemoqna.000webhostapp.com/js/test.json";
		...
		var event = {
					...
					startDate: new Date(myData[i].startYear, myData[i].startMonth, myData[i].startDay),
					endDate: new Date(myData[i].endYear,  myData[i].endMonth,  myData[i].endDay)

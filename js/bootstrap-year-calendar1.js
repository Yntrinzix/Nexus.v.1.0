 ...
 * ========================================================= */
 ...
 (function($) {
	...
	var colors = $.fn.calendar.colors = ['#2C8FC9', '#9CB703', '#F5BB00', '#FF4A32', '#B56CE2', '#45A597','#c356a1','#ff8a00','#ffffff','#b9f8ff','#d7ffb9'];
		...
		console.log(userID);
				...
				if(userID==1){
					...
					for(i=0 ; i < myData.length ; i++){
						...
						$('#calendar').data('calendar').setContextMenuItems(employeeMenu);
